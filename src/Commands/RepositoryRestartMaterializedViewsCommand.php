...
class RepositoryRestartMaterializedViewsCommand extends Command
{
    protected $signature = 'repository:restart-materialized-views';

    protected $description = 'Command to reinstall as materialized views';
    ...
    protected function processRepositories(array $repositories): void
    {
        ...
        foreach ($repositories as $repositoryContract) {
            ...
            try {
                ...
                $this->error("    [ERROR] Failed to restart: " . $e->getMessage());
            }
            $bar->advance();
        }
